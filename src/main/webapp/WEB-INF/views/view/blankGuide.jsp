                    ...
                    <div class="guide-box top" style="flex-shrink: 0;">
                      ...
                      <div class="select-box">
                        ...
                        <select name="" id="">
                          ...
                          <option value="">Convert(90˚)</option>
                        </select>
                      </div>
                    </div>
                  </div>
...
<%--                    <input id="11" type="checkbox" name="" class="input-checkbox">--%>
<%--                    <label for="11" class="label">--%>
<%--                        <span class="label-text">Don't look at it for 15 days</span>--%>
<%--                    </label>--%>
<%--                </span>--%>
<%--      <button type="button" class="btn-start btn-close">START</button>--%>
<%--    </div>--%>
  </div>
</div>
