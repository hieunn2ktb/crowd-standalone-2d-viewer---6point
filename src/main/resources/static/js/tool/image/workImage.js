...
page.init = function () {
    ...
    page.data.drawing.lastSelectedClass.classColor = page.data.task.classMap.get(page.data.task.defaultClassId).color;
...
page.fn.event.movePointStart = function (event, target) {
    ...
    if (page.data.event.target.attr("rot") == "Y") {
        page.data.event.point.isRect = true;
        page.data.event.point.rotation = true;
        page.data.event.point.rad = 0;
        if (page.data.drawing.object.location.length > 2) {
            page.data.event.point.rad = page.data.drawing.object.location[2][0];
        }
    }
}
...
createCube2DDismiss = function(fileIndex, object, objectBoxSize) {
    ...
    if(g) {
        ...
        image.setAttribute("href", "/images/tool/annImage/draw-cube-2d-close.png");
    ...
    try {
        ...
        location.forEach(function (p) {
            ...
            if(typeof(p[3]) != "undefined") {
                ...
                let data = null;
                if(index > 0) {
                    points = prePoint[0] + "," + prePoint[1] + " " + p[0] + "," + p[1];
                    data = prePoint[3];
                    ...
                    o.setAttribute("class", "draw-object");
                    ...
                    o.setAttribute("data-objectType", object.objectType);
                    o.setAttribute("data-file-index", fileIndex);
                    o.setAttribute('stroke', cc);
                    g.append(o);
                }
            }
            prePoint = p;
...
page.fn.data.getObjectPosition = function (fileIndex, object) {
    ...
    if (object.objectType == page.constants.drawType.rectangle || object.objectType == 'drawCube2DFront' || object.objectType == 'drawCube2D') {
        max = 2;
    } else if (object.objectType == page.constants.drawType.rectangle4p) {
        max = 4;
    }
...
page.fn.data.changeTicket = function (ticketId) {
    ...
    $(".drawingImage").prop("src", "/images/tool/annImage/empty.png")
        .attr("file-path", "");
